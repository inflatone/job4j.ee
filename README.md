# Избранные и дополненные проекты курса «С нуля до трудоустройства, Фуллстек Java + JS» (Junior+/Middle) на <a href="https://job4j.ru/courses/java_with_zero_to_job.html">job4j.ru</a>
